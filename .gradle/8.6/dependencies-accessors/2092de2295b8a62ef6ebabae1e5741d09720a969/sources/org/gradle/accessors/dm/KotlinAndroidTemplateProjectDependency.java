...
@NonNullApi
public class KotlinAndroidTemplateProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KotlinAndroidTemplateProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
